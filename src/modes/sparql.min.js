goog.provide("modes.sparql");(function(mod){if(typeof exports=="object"&&typeof module=="object")
...
else if(ch=="<"&&!stream.match(/^[\s\u00a0=]/,!1)){stream.match(/^[^\s\u00a0>]*>?/);return "atom"}
...
return context.col+(closing?0:1);else return context.indent+(closing?0:indentUnit)},lineComment:"#"}});CodeMirror.defineMIME("application/sparql-query","sparql")})
