goog.provide("org.knotation.editor.modes.turtle");(function(mod){if(typeof exports=="object"&&typeof module=="object")
...
var ops=wordRegexp([]);var keywords=wordRegexp(["@prefix","@base","a"]);var operatorChars=/[*+\-<>=&|]/;function tokenBase(stream,state){var ch=stream.next();curPunc=null;if(ch=="<"&&!stream.match(/^[\s\u00a0=]/,!1)){stream.match(/^[^\s\u00a0>]*>?/);return "atom"}
...
return context.col+(closing?0:1);else return context.indent+(closing?0:indentUnit)},lineComment:"#"}});CodeMirror.defineMIME("text/turtle","turtle")})
