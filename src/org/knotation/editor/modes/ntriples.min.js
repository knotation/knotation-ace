goog.provide("org.knotation.editor.modes.ntriples");(function(mod){if(typeof exports=="object"&&typeof module=="object")
...
if(ch=='.'){transitState(state,ch)}}}});CodeMirror.defineMIME("application/n-triples","ntriples");CodeMirror.defineMIME("application/n-quads","ntriples");CodeMirror.defineMIME("text/n-triples","ntriples")})
